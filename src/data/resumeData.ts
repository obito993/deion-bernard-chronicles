export const resumeData = {
  ...
  skills: {
    ...
    webDev: ["HTML", "CSS", "React", "Node.js", "ASP.NET", "Next.js", "TypeScript", "Tailwind CSS"],
  ...
  certifications: [
    ...
    "Web Development Fundamentals — IBM (Mar 2025)",
    "Data Science and Analytics — HP LIFE (Feb 2025)",
    "Introduction to Artificial Intelligence — Google (Aug 2023)",
    "Object-Oriented Programming using Python — Infosys Springboard",
    "Introduction to MongoDB — MongoDB (Jun 2024)",
    "React for Beginners + Introduction to SQL — Skill Up",
  ],
  extraCurricular: [
  ...
  achievements: [
    ...
    "College proficiency showcasing problem solving ability and programming.",
  ],
  workshops: [
